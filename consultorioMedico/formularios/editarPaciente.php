                                    ...
                                    <div class="card-body">
                                        <form method="Post" action="../scriptsSQL/insertPaciente.php">
                                            <div class="row mb-3">
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        <input class="form-control" id="inputFirstName" type="text" placeholder="Enter your first name" name="pacienteID" value="<?php  echo "$idPaciente"; ?>" disabled readonly/><!-- value="<?php# $idDoc ?>" disabled readonly -->
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-md-6"> 
                                                <div class="form-floating mb-3 mb-md-0">
                                                        <input class="form-control" id="inputFirstName" type="number" placeholder="Enter your first name" name="pacienteCita"/>
                                                        <label for="inputFirstName">ID Cita paciente</label>
                                                    </div>
                                                </div> 
                                            </div>
