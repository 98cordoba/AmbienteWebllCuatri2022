                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header text-success"><h3 class="text-center font-weight-light my-4">Modificar</h3></div>
                                    <div class="card-body text-success">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="mt-4 mb-0">
                                            <div class="d-grid"><button type="submit" class="btn btn-success" >Actualizar Doctor</button></div>
                                            </div>
                                        </form>
                                    </div>
                                    <div class="card-footer text-center py-3">
                                        <div class="small"><a class="link-success" href="../tablas/tablaDoctores.php">Cancelar</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
