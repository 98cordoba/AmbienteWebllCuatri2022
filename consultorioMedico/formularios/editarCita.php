                                            ...
                                            <div class="row mb-3">
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        <input class="form-control" id="inputFirstName" type="text" placeholder="Enter your first name" name="citaID" value="<?php  echo "$idCita"; ?>" disabled readonly/><!-- value="<?php# $idDoc ?>" disabled readonly -->
                                                        <label for="inputFirstName"><!--<?php #echo "$idCita"; ?> --> ID</label> 
                                                    </div>
                                                </div>
                                            </div>  
                                                <div class="row mb-3">
