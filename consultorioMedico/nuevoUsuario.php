                                    ...
                                    <div class="card-body">
                                        <form method="Post" action="insertUsuario.php">
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-floating">
                                                        <input class="form-control" id="inputLastName" type="number" placeholder="Enter your last name" name="tipoUsuario"/>
                                                        <label for="inputLastName">tipoUsuario</label> <!-- Cambiar por select group -->
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="mt-4 mb-0">
