...
CREATE PROCEDURE `consultoriomedico`.`spActualizaContraseña`(in pnombreUsuario varchar(45), in ppasswordUsuario VARCHAR(45), in ptipoUsuario int, in pidUsuarios int)
    BEGIN
	update usuarios 
...
CREATE PROCEDURE `consultoriomedico`.`spActualizaPaciente`(in pnombrePaciente varchar(45), in papellidosPaciente VARCHAR(45), in pcedulaPaciente int , in pfechaNacimiento VARCHAR(10),in ptelefonoPaciente int,in pcorreoPaciente varchar(45) ,in pidPaciente int)
    BEGIN
	update pacientes 
...
CREATE PROCEDURE `consultoriomedico`.`spActualizaDoctor`(in pnombreDoctor varchar(45), in papellidosDoctor VARCHAR(45), in pcedulaDoctor int ,in ptelefonoDoctor int, in pcorreoDoctor VARCHAR(45), in pespecialidad varchar(45) ,in ptipoUsuario int,in pidDoctor int)
    BEGIN
	update doctor 
