                ...
                <div class="container-fluid px-4">
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="card" >
                                <div class="card-body">
                                <h6 class="card-subtitle mb-2 text-muted">Estimado Usuario</h6>
                                <p class="card-text">
                                    Se le recuerda que al ingresar a la empresa usted firmo un contrato especifico
                                    a su cargo, en el cual usted acepto una serie de condiciones con respecto a lo que 
                                    la empresa crea conveniente con sus funciones dentro de las instalaciones de trabajo o fuera de ellas
                                    como lo puede ser sus politicas de privacidad o exposicion de la marca. 
                                    En caso de cualquier duda con este tema, se le recomienda 
